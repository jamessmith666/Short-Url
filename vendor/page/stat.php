<html>
	<head>
		<title>Statistic : <?=URL.'/'.$show['id'];?></title>
		...
		<meta name="author" content="Hck.my.id">
		<meta name="copyright" content="Copyright &copy; Hck.my.id. All Rights Reserved." />
...
<body>
		<div class="wrap"><span class="text"><?=number_format($show['views']);?></span></div>
	</body>
</html>
