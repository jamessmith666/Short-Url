...
require __DIR__.'/enc.php5';
	...
	switch (true) {
        ...
        switch (true) {
			...
			print "<script> tod.success({ status: 'Success', message: 'Your URL has been shortened!', align: 'topright' }); </script>";
	...
	} break; default: $data = json(__DIR__.'/vendor/database/'.db); define('total', count((array)$data));  $show = json(__DIR__.'/vendor/database/'.setup); load(__DIR__.'/vendor/page/form.php', $show);
 } 
